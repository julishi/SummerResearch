"""
This code Is based on Alex Krizhevsky tutorial I am following. I will be modifying and editing in places to test as needed. 

The following is written by Alex Krizhevsky: 
...
class AlexNet(object):
          ...
          def __init__(self, x, keep_prob, num_classes, skip_layer, weights_path = 'DEFAULT'):
               ...
               - keep_prob: tf.placeholder, for the droupout rate
               - num_classes: int, number of classes of the new dataset
               - skip_layer: list of strings, names of the layers to reinitialize
               - weights_path: path string, path to the pretrained weights, (if bvlc_alexnet.npy is not in the same folder)
               """
